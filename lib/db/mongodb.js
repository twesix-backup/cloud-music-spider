...
(async function test()
{
    ...
    //
    // console.log(await module.exports.findPlaylistUnprocessed())
    // console.log(await module.exports.findPlaylistUnprocessed())
    //
    ...
    // while(1)
    // {
    //     const res = await db.collection('users').findOneAndDelete({})
    //     if(res.value === null) break
    //     try
    //     {
    //         await db.collection('user').insertOne(res.value)
    //         num ++
    //     }
    //     catch(e)
    //     {
