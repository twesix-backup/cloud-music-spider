...
const $conn = module.exports.getConnection()
...
(async function test()
{
    ...
    await module.exports.updateUserProcessed({ id: 'test' })
    await module.exports.updateUserProcessed({ id: 'test' })
    
    await module.exports.findUserUnprocessed()
    await module.exports.findUserUnprocessed()
    
    await module.exports.insertComment({ id: 'test'})
    await module.exports.insertComment({ id: 'test'})
    ...
    await module.exports.updateSongProcessed({ id: 'test'})
    await module.exports.updateSongProcessed({ id: 'test'})
    await module.exports.updateSongProcessed({ id: 'test'})
