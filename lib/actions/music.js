...
(async function()
{
    ...
    // console.log(await module.exports(false, false))
    // console.log(await module.exports(config.mid, config.proxy))
    // console.log(await module.exports(config.mid, 'http://cs.twesix.cn:65535'))
})()